<div class="top-news">
	...
	<h2 class="section-title top-news__title">
		留学情報<br>
		<span class="lang-china">
			<span class="lang-china-han">留学情報(外1)　</span>
			<span class="lang-china-kan">留学情報(外2)</span>
		</span>
	</h2>
			...
			<li class="top-news__item">
				...
				<div class="top-news__item--content">
					<h4 class="top-news__item--title">
						留学生インタビュー
						<span class="lang-china">
							<span class="lang-china-han">留学生インタビュー(外1)</span>　<span class="lang-china-kan">留学生インタビュー(外2)</span>
						</span>
					</h4>
					<div class="top-news__item--text">
						<ul>
